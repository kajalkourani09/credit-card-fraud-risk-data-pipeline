...
Built an end-to-end GCP-based credit card fraud risk data pipeline using PySpark, BigQuery, Google Cloud Storage, Dataproc Serverless, Cloud Composer/Airflow, PyTest, and GitHub Actions. The pipeline detects daily transaction files, triggers serverless Spark processing, enriches transaction data with cardholder information, calculates fraud risk levels, writes processed data to BigQuery, and archives processed files automatically.
